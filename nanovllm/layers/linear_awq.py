...
class ReplicatedLinear(LinearBase):
    ...
    def __init__(
        ...
        super().__init__(input_size, output_size, bias, None, group_size, bits)
...
class ColumnParallelLinear(LinearBase):
    ...
    def __init__(
        ...
        super().__init__(input_size, divide(output_size, tp_size), bias, 0, group_size, bits)
...
class MergedColumnParallelLinear(ColumnParallelLinear):
    ...
    def __init__(
        ...
        super().__init__(input_size, sum(output_sizes), bias, None, group_size, bits)
...
class QKVParallelLinear(ColumnParallelLinear):
    ...
    def __init__(
        ...
        super().__init__(hidden_size, output_size, bias, group_size, bits)
...
class RowParallelLinear(LinearBase):
    ...
    def __init__(
        ...
        tp_size = get_tp_group().world_size
        super().__init__(divide(input_size, tp_size), output_size, bias, 1, group_size, bits)
